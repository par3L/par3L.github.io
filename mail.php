...
if (isset($_POST['submit'])) {
    ...
    if ($file_size > 2097152){
        ...
        if (move_uploaded_file($temp_name, 'images/'. $file_name)){
            ...
            $sql = "INSERT INTO form (namez, email, phone, device, issue, foto) VALUES ('$name', '$email', '$phone', '$device', '$issue', '$file_name')";
    ...
    <main>
        ...
        <section id="form-section">
            <?php if (!isset($_SESSION['login'])): ?>
                <div class="alert">Please log in to use the form!</div>
            <?php endif; ?>
            <form action='' method="post" id="mail-in-form" enctype="multipart/form-data" 
            class ="<?php echo (!isset($_SESSION['login'])) ? 'blurred' : ''; ?>">
